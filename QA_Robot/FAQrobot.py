...
class FAQrobot(object):
    def __init__(self, zhishitxt='question_answer.txt', lastTxtLen=10, usedVec=False):
    ...
    def load_embedding(self, gensim=None):
    ...
    def maxSimTxt(self, intxt, simCondision=0.1, simType='simple'):
        ...
        if maxSim.sim < simCondision:
            return '不好意思，我没有理解您的意思。请询问有关教学的话题或者增加一些关键字再次尝试。'
...
if __name__ == '__main__':
    ...
    robot = FAQrobot(file_txt, usedVec=False)
    while True:
        # simType=simple, simple_pos, vec, all
